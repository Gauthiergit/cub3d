...
/*   Updated: 2024/05/13 17:47:54 by gdetourn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->player.map_x = floor(data->player.px_x / SQUARE_SIZE);//x + 0.5;
	data->player.map_y = floor(data->player.px_y / SQUARE_SIZE);//y + 0.5;
	if (data->scene[y][x] == 'N')
